...
public class Menu {
    ...
    public void paint(Graphics g) {
        ...
        g.drawImage(m_img[1], (Options.d.width / 2) - (((BufferedImage) m_img[1]).getWidth() / 2), (Options.d.height / 4) + ((BufferedImage) m_img[1]).getHeight(), ((BufferedImage) m_img[1]).getWidth(), ((BufferedImage) m_img[1]).getHeight(), null);
        ...
        g.drawImage(m_img[6],30,30,300,100,null);
